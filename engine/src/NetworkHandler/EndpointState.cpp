...
std::chrono::time_point<std::chrono::steady_clock> EndpointState::getLastPing() const { return this->_lastPing; }
...
void EndpointState::setLastPing(std::chrono::time_point<std::chrono::steady_clock> newLastPing) { this->_lastPing = newLastPing; }

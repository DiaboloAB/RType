...
class NullRuntime : public IRuntime
{
   public:
    ...
    int loadMusic(const std::string& filePath) override { return false; }
    void playMusic(const int soundID, bool loop) override {}
    void stopCurrentMusic() override {}
    void unloadMusic(const int soundID) override {}

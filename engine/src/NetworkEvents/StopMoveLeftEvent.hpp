 ...
 *
 * @brief Class used to manage in-game entities when a STOP_MOVE_LEFT
...
class StopMoveLeftEvent
{
   public:
    ...
    /**
     * @brief Updates the client's direction to stop leftward movement. Sends the updated direction
     * to other clients to ensure they stop moving this client to the left as well.
     *
     * @param sender: Sender endpoint of the game event.

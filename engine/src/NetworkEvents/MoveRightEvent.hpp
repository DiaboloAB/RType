 ...
 *
 * @brief Class used to manage in-game entities when a MOVE_RIGHT
...
class MoveRightEvent
{
   public:
    ...
    /**
     * @brief Updates the client's direction to move rightward. Sends the updated direction to other
     * clients to ensure they move this client to the right as well.
     *
     * @param sender: Sender endpoint of the game event.

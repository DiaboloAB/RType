 ...
 *
 * @brief Class used to manage in-game entities when a STOP_MOVE_DOWN
...
class StopMoveDownEvent
{
   public:
    ...
    /**
     * @brief Updates the client's direction to stop downward movement. Sends the updated direction
     * to other clients to ensure they stop moving this client downward as well.
     *
     * @param sender: Sender endpoint of the game event.

...
namespace RType::Network {
    ...
    MoveEntityPacket::MoveEntityPacket(uint32_t entityId, float posX, float posY, float directionX, float directionY) : APacket(MOVEENTITY),
    _entityId(entityId), _posX(posX), _posY(posY), _directionX(directionX), _directionY(directionY) {

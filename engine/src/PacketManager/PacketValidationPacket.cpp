...
PacketType PacketValidationPacket::getPacketReceiveType() const
{
    return this->_packetReceiveType;
}

uint64_t PacketValidationPacket::getPacketTimeStamp() const
{
    return this->_packetTimeStamp;
}
}  // namespace RType::Network
